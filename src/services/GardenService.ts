...
export const PLANTS: Record<string, PlantDefinition> = {
  moonflower: {
    ...
    growTimeMinutes: 60, baseYield: 3, sellPrice: 100, seedPrice: 110,
  ...
  starbloom: {
    ...
    growTimeMinutes: 120, baseYield: 2, sellPrice: 170, seedPrice: 280,
  ...
  twilight_rose: {
    ...
    growTimeMinutes: 30, baseYield: 4, sellPrice: 45, seedPrice: 40,
  ...
  crystalvine: {
    ...
    growTimeMinutes: 180, baseYield: 1, sellPrice: 420, seedPrice: 650,
  ...
  dreamcap: {
    ...
    growTimeMinutes: 45, baseYield: 5, sellPrice: 75, seedPrice: 80,
  ...
  sunpetal: {
    ...
    growTimeMinutes: 25, baseYield: 5, sellPrice: 30, seedPrice: 25,
  ...
  shadowbloom: {
    ...
    growTimeMinutes: 300, baseYield: 1, sellPrice: 1100, seedPrice: 1600,
